# Collector for Humoutcomes Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-humoutcomes/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-humoutcomes/actions/workflows/run-python-tests.yaml)
...
This script queries the Humanitarian Outcomes API once every day and creates one global dataset and one country specific dataset for HRP countries. Sensitive geo data is removed for Palestine.
 ...
 **hdx-scraper-humoutcomes** as specified in the parameter
 *user_agent_lookup*.
...
```shell
    pip install .
    python -m hdx.scraper.humoutcomes
```
